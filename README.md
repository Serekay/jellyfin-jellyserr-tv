...
1. Install “ADB TV” or an similar App on the TV.
...
3. In ADB TV run, one by one:
   ...
   ```
4. Restart the TV. Tailscale connects automatically; Netflix/YouTube and other traffic remain outside the VPN (lockdown=0).
